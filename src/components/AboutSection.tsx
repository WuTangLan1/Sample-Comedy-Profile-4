      ...
      <Container>
        <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, alignItems: 'center', gap: 4 }}>
          ...
          <Box sx={{ flex: 1, textAlign: { xs: 'center', md: 'left' } }}>
            ...
            <Typography variant="body1" sx={{ textAlign: 'justify', lineHeight: 1.8, color: theme.palette.mode === 'light' ? 'text.primary' : 'text.secondary', background: theme.palette.mode === 'light' ? 'none' : 'linear-gradient(45deg, #ffffff10 30%, #ffffff05 90%)', p: theme.palette.mode === 'light' ? 0 : 1, borderRadius: theme.palette.mode === 'light' ? 0 : 2 }}>
